// 환경 변수 및 설정 관리
export const config = {
  apiBaseURL: import.meta.env.VITE_API_BASE_URL || 'http://192.168.75.99:8089/api',
  imageBaseURL: import.meta.env.VITE_IMAGE_BASE_URL || 'http://192.168.75.99:8089/images',
