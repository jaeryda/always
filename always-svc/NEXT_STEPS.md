...
- `http://192.168.75.99:8089/api/hello` - Hello 메시지
- `http://192.168.75.99:8089/api/posts` - 모든 포스트 조회 (MySQL에서)
...
브라우저에서 `http://192.168.75.99:8080` 접속 후:
...
**GET - 모든 포스트 조회**
```
GET http://192.168.75.99:8089/api/posts
```

**GET - 특정 포스트 조회**
```
GET http://192.168.75.99:8089/api/posts/1
```

**POST - 포스트 생성**
```
POST http://192.168.75.99:8089/api/posts
...
**PUT - 포스트 수정**
```
PUT http://192.168.75.99:8089/api/posts/1
Content-Type: application/json
...
**DELETE - 포스트 삭제**
```
DELETE http://192.168.75.99:8089/api/posts/1
```
