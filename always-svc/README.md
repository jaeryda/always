...
서버가 실행되면 기본적으로 `http://192.168.75.99:8089`에서 실행됩니다.
...
const api = axios.create({
  baseURL: 'http://192.168.75.99:8089/api',
  // ...
})
```
...
```env
VUE_APP_API_BASE_URL=http://192.168.75.99:8089/api
```
...
- H2 콘솔: `http://192.168.75.99:8089/h2-console`
