...
**예제 (cURL):**
```bash
curl -X POST http://192.168.0.2:8089/api/posts/1/image \
...
**GET** `http://192.168.0.2:8089/images/{filename}`

브라우저에서 직접 접속 가능:
```
http://192.168.0.2:8089/images/a1b2c3d4-e5f6-7890-abcd-ef1234567890.jpg
```
...
```json
{
  ...
  "imageUrl": "http://192.168.0.2:8089/images/a1b2c3d4-e5f6-7890-abcd-ef1234567890.jpg",
  "timestamp": "..."
}
```
...
1. **이미지 업로드**:
   - Method: POST
   - URL: `http://192.168.0.2:8089/api/posts/1/image`
   - Body: form-data
   - Key: `file` (type: File)
   - Value: 이미지 파일 선택

2. **이미지 확인**:
   - 브라우저에서: `http://192.168.0.2:8089/images/{filename}`
